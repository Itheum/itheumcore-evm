...
import "./DataDexReleaseV2.sol";
import "./SharedStructs.sol";

contract DataNFTReleaseV2 is Initializable, ERC721Upgradeable {
    ...
    DataDexReleaseV2 public dataDex;
    ...
    function initialize(DataDexReleaseV2 _dataDex, string memory tokenName, string memory tokenID) public initializer {
        __ERC721_init(tokenName, tokenID);
